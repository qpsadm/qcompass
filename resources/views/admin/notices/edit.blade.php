        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('admin.notices.update', ['notice' => $notice->id]) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="agenda_name" value="{{ old('agenda_name', $notice->agenda_name) }}"
                ...
                <div class="mb-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="is_show" value="1"
                            {{ old('is_show', $notice->is_show) ? 'checked' : '' }} class="mr-2">
                        表示する
                    </label>
                </div>
                ...
                <button type="submit" class="save bg-blue-500 text-white px-4 py-2 rounded">更新</button>
            </form>
        </div>
