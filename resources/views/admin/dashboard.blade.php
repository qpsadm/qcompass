...
@section('content')
    <div class="container py-6 w-full">
                    ...
                    <ul class="space-y-2 p-6 pb-0">
                        @foreach ($latestAgendas as $agenda)
                            <li class="flex flex-row gap-2 pb-0 items-center">
                                ...
                                <span class="text-sm text-gray-500">【{{ $agenda->category->name }}】</span>
                            </li>
                        @endforeach
                    </ul>
                        ...
                        @foreach ($latestReports as $report)
                            <li class="flex flex-row gap-2 pb-0 items-center">
                                ...
                                <a href="{{ route('admin.reports.show', $report->id) }}"
                                    class="font-medium text-blue-600 hover:underline">
                                    {{ $report->title }} 【{{ $report->user->name ?? '不明' }}】
                                </a>
                            </li>
                        @endforeach
                    </ul>
                ...
                @else
                    <ul class="space-y-2 p-6 pb-0">
                        @forelse ($users as $user)
                            <li class="flex flex-row items-center gap-2 pb-0 items-center">
                                <!-- 作成日時 -->
                                <div class="text-sm text-gray-500">
