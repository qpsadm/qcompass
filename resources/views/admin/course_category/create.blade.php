...
@section('content')
    <div class="container max-w-5xl">
        <div class="bg-white rounded-lg shadow-md p-6">
            <h1 class="text-2xl font-bold mb-6 text-gray-800">講座カテゴリ 作成</h1>
            ...
            <form action="{{ route('admin.course_category.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        @foreach ($categories as $category)
                            <label
                                class="flex items-center space-x-2 border px-3 py-2 rounded cursor-pointer hover:bg-gray-50">
                ...
                <div class="mb-6">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <input type="checkbox" name="is_show" value="1" @checked(old('is_show', 1))
                            class="h-4 w-4 text-blue-600 border-gray-300 rounded">
