...
<div class="container mx-auto p-6 pb-24"> {{-- pb-24 でフッター分の余白 --}}
    ...
    <div class="mb-4 flex justify-end">
        ...
        @endphp
        <a href="{{ route('admin.roles.index', ['order' => $toggleOrder]) }}"
        ...
        <table class="min-w-full border border-gray-200">
            <thead>
                <tr class="bg-gray-100 text-left text-gray-700">
                    ...
                    <th class="border-b px-4 py-2 text-center w-1/6">管理番号</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50" x-data="{ open: false, deleteName: '', deleteUrl: '' }">
                    ...
                    <td class="border-b px-4 py-2 text-center">{{ $role->role_id }}</td>
                    ...
                    <td class="border-b px-4 py-2 text-center flex justify-center gap-2">
                        ...
                        {{-- 削除 --}}
                        <button @click="deleteName='{{ $role->role_name }}'; deleteUrl='{{ route('admin.roles.destroy', $role->id) }}'; open=true;"
