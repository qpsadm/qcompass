...
<div class="container mx-auto p-6 pb-24 max-w-6xl" x-data="{ open: false, deleteUrl: '', deleteName: '' }">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex items-center justify-between mb-4">
            ...
            {{-- 右：検索フォーム --}}
            <div x-data="searchBox()" class="flex items-center space-x-2 flex-1 justify-end ml-4">
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <a href="{{ route('admin.courses.show', $course->id) }}" class="text-green-600 hover:text-green-700 flex items-center space-x-1">
                                    <img src="{{ asset('assets/images/icon/b_agenda.svg') }}" class="w-4 h-4">
                                    <span class="hidden lg:inline ml-1">詳細</span>
                                </a>
                                <a href="{{ route('admin.courses.edit', $course->id) }}" class="text-blue-600 hover:text-blue-700 flex items-center space-x-1">
                                    <img src="{{ asset('assets/images/icon/b_report.svg') }}" class="w-4 h-4">
                                    <span class="hidden lg:inline ml-1">編集</span>
                                </a>
                                <button @click="open = true; deleteUrl='{{ route('admin.courses.destroy', $course->id) }}'; deleteName='{{ $course->course_name }}';" class="text-red-600 hover:text-red-700 flex items-center space-x-1">
