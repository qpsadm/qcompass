            ...
            <form action="{{ route('admin.courses.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="course_code" value="{{ old('course_code') }}"
                        class="border px-2 py-1 w-1500 rounded" required>
                </div>

                {{-- 講座分野 --}}
                <div class="mb-4">
                    <label class="block font-medium mb-1 text-gray-700">講座分野</label>
                    <select name="course_type_ID" class="border px-2 py-1 w-500 rounded" required>
                ...
                <div class="mb-4">
                    ...
                    <select name="Level_id" class="border px-2 py-1 w3000 rounded" required>
                        <option value="">選択してください</option>
                ...
                <div class="mb-4">
                    ...
                    <select name="organizer_id" class="border px-2 py-1 w-1000 rounded" required>
                        <option value="">選択してください</option>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="course_name" value="{{ old('course_name') }}"
                        class="border px-2 py-1 w-1000 rounded" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="total_hours" value="{{ old('total_hours') }}"
                        class="border px-2 py-1 w-250 rounded">
                </div>
