            ...
            <form action="{{ route('admin.courses.store') }}" method="POST">
                ...
                <div class="mb-4 flex flex-col md:flex-row gap-4">
                    <div class="flex-1">
                        ...
                        <input type="date" name="start_viewing" id="start_viewing"
                            value="{{ old('start_viewing') }}"
                            class="border-gray-300 border px-2 py-1 w-full rounded-md
                                  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div class="flex-1">
                        <label for="finish_viewing" class="block font-medium mb-1">閲覧終了</label>
                        <input type="date" name="finish_viewing" id="finish_viewing"
                            value="{{ old('finish_viewing') }}"
                            class="border-gray-300 border px-2 py-1 w-full rounded-md
                                  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                ...
                {{-- 作成者 --}}
                <div class="mb-4">
                    <label for="created_user_name" class="block font-medium mb-1 text-gray-700">作成者名</label>
                    <input type="text" name="created_user_name" id="created_user_name"
                        value="{{ old('created_user_name') }}"
                        class="border-gray-300 border px-2 py-1 w-[300px] rounded-md
                              focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
