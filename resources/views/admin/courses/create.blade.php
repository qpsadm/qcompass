...
@section('content')
    <div class="container mx-auto max-w-5xl">
        <div class="bg-white rounded-lg shadow-md p-6 mx-auto">
            ...
            <h1 class="text-2xl font-bold mb-6 text-gray-800">講座情報 新規作成</h1>
            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <tbody>
                                ...
                                <select name="course_type_id" class="border rounded px-3 py-2 w-64">
                                    ...
                                    @foreach ($courseTypes as $type)
                                        <option value="{{ $type->id }}"
                                            {{ old('course_type_id') == $type->id ? 'selected' : '' }}>{{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 flex gap-2">
                                ...
                                /
                                <input type="number" name="periods" value="{{ old('periods') }}"
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                <input type="date" name="certification_date" value="{{ old('certification_date') }}"
                                    class="border rounded px-3 py-2">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                <input type="text" name="certification_number"
                                    value="{{ old('certification_number') }}" class="border rounded px-3 py-2 w-64">
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 flex gap-2">
                                <input type="date" name="start_viewing" value="{{ old('start_viewing') }}"
                                    class="border rounded px-3 py-2">
                                ～
                                <input type="date" name="finish_viewing" value="{{ old('finish_viewing') }}"
                                    class="border rounded px-3 py-2">
                                @error('start_viewing')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                <input type="text" name="cc_address" value="{{ old('cc_address') }}"
                                    class="border rounded px-3 py-2 w-80">
                                @error('cc_address')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                ...
                                <p class="text-gray-500 text-sm">※ 使用可能形式：PDF / Word（.doc, .docx）/ Excel（.xls, .xlsx）</p>
                                @error('plan_path')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                            </td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                ...
                                <p class="text-gray-500 text-sm">※ 使用可能形式：PDF / 画像（pdf, jpg, png, webp）</p>
                                @error('flier_path')
                                    <p class="text-red-500 text-sm">{{ $message }}</p>
                                @enderror
                            </td>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 flex gap-2">
                                <input type="number" name="capacity" value="{{ old('capacity') }}"
                                    class="border rounded px-3 py-2 w-24">
                                /
                                <input type="number" name="entering" value="{{ old('entering') }}"
                                    class="border rounded px-3 py-2 w-24">
                                /
                                <input type="number" name="completed" value="{{ old('completed') }}"
                                    class="border rounded px-3 py-2 w-24">
                            </td>
                        </tr>
                ...
                <div class="mt-6 flex gap-3">
                    <button type="submit"
                        class="save bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded">保存</button>
