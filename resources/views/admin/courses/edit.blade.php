        ...
        <table class="w-full table-auto border-collapse">
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2 flex gap-2 flex-wrap">
                        ...
                        <input type="number" name="periods"
                            value="{{ old('periods', $course->periods ?? '') }}"
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <input type="date" name="application_date"
                            ...
                            class="border rounded px-3 py-2">
                        @error('application_date') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <input type="date" name="certification_date"
                            ...
                            class="border rounded px-3 py-2">
                        @error('certification_date') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <input type="text" name="certification_number"
                            ...
                            class="border rounded px-3 py-2 w-64">
                        @error('certification_number') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2 flex gap-2 flex-wrap">
                        ...
                        <input type="date" name="finish_viewing"
                            ...
                            class="border rounded px-3 py-2">
                        @error('start_viewing') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                        @error('finish_viewing') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <input type="email" name="mail_address" value="{{ old('mail_address', $course->mail_address ?? '') }}"
                            class="border rounded px-3 py-2 w-80">
                        @error('mail_address') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <input type="text" name="cc_address" value="{{ old('cc_address', $course->cc_address ?? '') }}"
                            class="border rounded px-3 py-2 w-80">
                        @error('cc_address') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        ...
                        <a href="{{ asset('storage/' . $course->plan_path) }}" target="_blank" class="text-blue-500 underline">
                            現在のファイルを確認
                        </a>
                        @endif
                    </td>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        ...
                        <a href="{{ asset('storage/' . $course->flier_path) }}" target="_blank" class="text-blue-500 underline">
                            現在のファイルを確認
                        </a>
                        @endif
                    </td>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2 flex gap-2 flex-wrap">
                        ...
                        <input type="number" name="entering" value="{{ old('entering', $course->entering ?? '') }}"
                            class="border rounded px-3 py-2 w-24">
                        /
                        <input type="number" name="completed" value="{{ old('completed', $course->completed ?? '') }}"
                            class="border rounded px-3 py-2 w-24">
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <select name="status" class="border rounded px-3 py-2 w-48">
                            ...
                            <option value="{{ $key }}" {{ old('status', $course->status ?? 0) == $key ? 'selected' : '' }}>
                                {{ $label }}
                            </option>
                            @endforeach
                        </select>
