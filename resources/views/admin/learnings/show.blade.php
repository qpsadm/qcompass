    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-4 text-center">
            ...
            <a href="{{ asset('storage/' . $learning->image) }}" target="_blank">
                <img src="{{ asset('storage/' . $learning->image) }}" class="w-32 h-32 object-cover rounded inline-block">
            </a>
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.learnings.edit', $learning->id) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                編集
            </a>
            <a href="{{ route('admin.learnings.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                一覧に戻る
            </a>
        </div>
    </div>
