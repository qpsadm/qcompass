...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('admin.user_details.update', $UserDetail->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-4">
                <label class="block font-medium mb-1">ユーザーID
                </label>
            ...
            <div class="mb-4">
                ...
                <select name="theme_color" class="border px-2 py-1 w-full rounded">
                    <option value="">選択してください</option>
                    <option value="0"
                        {{ old('theme_color', $UserDetail->theme_color ?? '') == '0' ? 'selected' : '' }}>赤</option>
                    <option value="1"
                        {{ old('theme_color', $UserDetail->theme_color ?? '') == '1' ? 'selected' : '' }}>青</option>
                    <option value="2"
                        {{ old('theme_color', $UserDetail->theme_color ?? '') == '2' ? 'selected' : '' }}>緑</option>
                    <option value="3"
                        {{ old('theme_color', $UserDetail->theme_color ?? '') == '3' ? 'selected' : '' }}>黄</option>
                </select>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block font-medium mb-1">所属部署</label>
