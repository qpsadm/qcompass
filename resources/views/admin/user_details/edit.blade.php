...
@section('content')
    <div class="container mx-auto p-4 max-w-5xl">
        ...
        <form action="{{ route('admin.user_details.update', ['user' => $user->id, 'detail' => $detail->id]) }}" method="POST"
            ...
            <table class="w-full table-auto border-collapse">
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <select name="gender" class="border rounded px-3 py-2 w-32">
                                ...
                                <option value="2" {{ old('gender', $detail->gender) == 2 ? 'selected' : '' }}>女性
                                </option>
                                <option value="9" {{ old('gender', $detail->gender) == 9 ? 'selected' : '' }}>その他
                                </option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <textarea name="bio" rows="3" class="border rounded px-3 py-2 w-full">{{ old('bio', $detail->bio) }}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <textarea name="note" rows="4" class="border rounded px-3 py-2 w-full">{{ old('note', $detail->note) }}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <input type="file" name="avatar_path" accept="image/*"
                                class="border rounded px-3 py-2 w-full" onchange="previewImage(event)">
                            <div class="mt-3">
                                <img id="avatarPreview" class="w-24 h-24 object-cover rounded-full border"
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <select name="avatar_type" class="border rounded px-3 py-2 w-40">
                                ...
                                <option value="1"
                                    {{ old('avatar_type', $detail->avatar_type) == 1 ? 'selected' : '' }}>デフォルト</option>
                                <option value="2"
                                    {{ old('avatar_type', $detail->avatar_type) == 2 ? 'selected' : '' }}>パターン1</option>
                                <option value="3"
                                    {{ old('avatar_type', $detail->avatar_type) == 3 ? 'selected' : '' }}>パターン2</option>
                                <option value="4"
                                    {{ old('avatar_type', $detail->avatar_type) == 4 ? 'selected' : '' }}>パターン3</option>
                                <option value="5"
                                    {{ old('avatar_type', $detail->avatar_type) == 5 ? 'selected' : '' }}>パターン4</option>
                                <option value="6"
                                    {{ old('avatar_type', $detail->avatar_type) == 6 ? 'selected' : '' }}>パターン5</option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <select name="status" class="border rounded px-3 py-2 w-40">
                                <option value="">選択</option>
                                <option value="1" {{ old('status', $detail->status) == 1 ? 'selected' : '' }}>有効
                                </option>
                                <option value="0"
                                    {{ (string) old('status', $detail->status) === '0' ? 'selected' : '' }}>無効</option>
                                <option value="2" {{ old('status', $detail->status) == 2 ? 'selected' : '' }}>停止
                                </option>
                            </select>
                        </td>
                    </tr>
