                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="gender" class="border px-2 py-1 w-full rounded">
                            ...
                            <option value="0" {{ old('gender', $UserDetail->gender) == '0' ? 'selected' : '' }}>男性</option>
                            <option value="1" {{ old('gender', $UserDetail->gender) == '1' ? 'selected' : '' }}>女性</option>
                            <option value="2" {{ old('gender', $UserDetail->gender) == '2' ? 'selected' : '' }}>その他</option>
                        </select>
                    </div>
                    ...
                    <!-- 必要に応じて残りの項目も同じスタイルで追加 -->
                </div>

                <div class="mt-6">
                    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">更新</button>
