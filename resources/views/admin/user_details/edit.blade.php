        ...
        <div x-show="tab === 'detail'" x-cloak>
            ...
            <form
                ...
                <div>
                    ...
                    <textarea name="note" rows="4" class="border px-3 py-2 rounded w-full">{{ old('note', $d->note ?? '') }}</textarea>
                </div>

                <div>
                    <label class="block font-semibold mb-1">備考</label>
                    <textarea name="memo" rows="4" class="border px-3 py-2 rounded w-full">{{ old('memo', $d->memo ?? '') }}</textarea>
                </div>
                ...
                <button>
                    <a href="{{ route('admin.users.index') }}"
                        class="inline-block bg-green-500 text-white px-4 py-2 rounded mt-2 hover:bg-green-600">
