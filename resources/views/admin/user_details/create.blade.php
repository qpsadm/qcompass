...
<div class="container mx-auto p-4 max-w-5xl">
    ...
    <form
        action="{{ route('admin.user_details.store', $user->id) }}"
        method="POST"
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <textarea
                            name="bio"
                            class="border rounded px-3 py-2 w-full h-24">{{ old('bio') }}</textarea>
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    ...
                    <td class="px-4 py-2">
                        <textarea
                            name="memo"
                            class="border rounded px-3 py-2 w-full h-24">{{ old('memo') }}</textarea>
                    </td>
                </tr>
        ...
        <div class="mt-6 flex gap-3">
            ...
            <a
                href="{{ route('admin.users.show', ['user' => $user->id, 'tab' => 'detail']) }}"
