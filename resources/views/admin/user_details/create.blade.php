        ...
        <form action="{{ route('admin.user_details.store', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <table class="w-full table-auto border-collapse">
                <tbody>
                    ...
                    {{-- 性別 --}}
                    <tr class="border-b">
                        <th class="bg-gray-100 text-right font-medium px-4 py-2">
                            性別
                        </th>
                        <td class="px-4 py-2">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <input type="text" name="address1" value="{{ old('address1') }}" placeholder="都道府県・市区町村・番地"
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <input type="text" name="address2" value="{{ old('address2') }}" placeholder="建物名・部屋番号"
                                class="border rounded px-3 py-2 w-full">
                        </td>
                    </tr>
                            ...
                            <select name="theme_id" class="border rounded px-3 py-2 w-40">
                                @foreach ($themes as $theme)
                                    <option value="{{ $theme->id }}"
                                        {{ old('theme_id', 1) == $theme->id ? 'selected' : '' }}>
                                        {{ $theme->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    {{-- 自己紹介 --}}
                    <tr class="border-b">
                        <th class="bg-gray-100 text-right font-medium px-4 py-2 align-top">
                            自己紹介
                        </th>
                        <td class="px-4 py-2">
