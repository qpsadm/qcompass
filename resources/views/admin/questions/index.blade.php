...
<div class="container mx-auto p-4 min-h-screen bg-white rounded-lg shadow-md" x-data="{ open: false, deleteUrl: '', deleteTitle: '' }">
    <h1 class="text-2xl font-bold mb-4 text-gray-800">質問一覧</h1>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border px-4 py-2 text-center">
                        <div class="flex items-center justify-center space-x-2">
                            <a href="{{ route('admin.questions.show', $question->id) }}" class="flex items-center text-green-600 hover:text-green-700">
                                <img src="{{ asset('assets/images/icon/b_agenda.svg') }}" class="w-4 h-4">
                                <span class="hidden lg:inline ml-1">詳細</span>
                            </a>
                            <a href="{{ route('admin.questions.edit', $question->id) }}" class="flex items-center text-blue-600 hover:text-blue-700">
