            ...
            <table class="w-full table-auto border-collapse">
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <textarea name="content" rows="4"
                                class="border rounded px-3 py-2 w-full" required>{{ old('content', $question->content) }}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <textarea name="answer" rows="4"
                                class="border rounded px-3 py-2 w-full" required>{{ old('answer', $question->answer) }}</textarea>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2"
                            x-data="{ is_show: {{ old('is_show', $question->is_show) }} }">
