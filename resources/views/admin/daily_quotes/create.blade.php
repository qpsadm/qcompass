...
@section('content')
    <div class="container mx-auto p-6 max-w-xl bg-white rounded-lg shadow-md">
        <h1 class="text-3xl font-bold mb-6 text-gray-800">DailyQuote 作成</h1>
        ...
        <form action="{{ route('admin.daily_quotes.store') }}" method="POST" class="space-y-4">
            ...
            <!-- quote -->
            <div>
                <label class="block text-gray-700 font-semibold mb-2">Quote</label>
            ...
            <div>
                <label class="block text-gray-700 font-semibold mb-2">表示日（display_date）</label>
            ...
            <!-- is_show -->
            <div>
                <label class="block text-gray-700 font-semibold mb-2">表示する？（is_show）</label>
                <select name="is_show"
                    class="w-full border-gray-300 rounded-md shadow-sm px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
