            ...
            <tbody>
                ...
                <tr x-data="{ open: false }" class="hover:bg-gray-50">
                    ...
                    <td class="border-b px-4 py-2 text-center flex justify-center gap-2">
                        <a href="{{ route('admin.daily_quotes.show', $quote->id) }}" class="text-green-500 hover:underline">詳細</a>
                        <a href="{{ route('admin.daily_quotes.edit', $quote->id) }}" class="text-blue-500 hover:underline">編集</a>
                        ...
                        <div x-show="open" x-cloak x-transition.opacity.duration.200ms
                            ...
                            <div x-show="open" x-transition.scale.duration.200ms
                                ...
                                <div class="flex justify-center gap-4">
                                    ...
                                    <form action="{{ route('admin.daily_quotes.destroy', $quote->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
