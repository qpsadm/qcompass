...
<div class="container mx-auto p-4 min-h-screen"
    ...
    <div class="bg-white rounded-lg shadow-md p-6 max-w-5xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800">技術分類タグ 編集</h1>
        </div>
            ...
            <table class="w-full table-auto border-collapse bg-white rounded-lg shadow-sm">
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3"
                            x-data="{ is_show: {{ old('is_show', $Tag->is_show ?? 0) }} }">
    ...
    <div x-show="deleteOpen"
        ...
        <div x-show="deleteOpen"
            ...
            <p class="text-center text-gray-700 mb-5">
                「<span class="font-semibold">{{ $Tag->name }}</span>」を
                削除しますか？
            </p>
