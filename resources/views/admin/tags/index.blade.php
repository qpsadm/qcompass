        ...
        <table class="min-w-full border border-gray-200">
            <thead>
                <tr class="bg-gray-100 text-left text-gray-700">
                    ...
                    <th class="border-b px-4 py-2 text-center w-1/6">用途分類</th>
                    <th class="border-b px-4 py-2 text-center w-1/12">色</th>
                    <th class="border-b px-4 py-2">説明</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50" x-data="{ open: false, deleteName: '', deleteUrl: '' }">
                    ...
                    <td class="border-b px-4 py-2 text-center">{{ $tag->tag_type }}</td>
                    <td class="border-b px-4 py-2 text-center">{{ $tag->theme_color }}</td>
                    <td class="border-b px-4 py-2">{{ $tag->description }}</td>
                    <td class="border-b px-4 py-2 text-center flex justify-center gap-2">
                        {{-- 編集 --}}
                        <a href="{{ route('admin.tags.edit', $tag->id) }}" class="text-blue-500 hover:underline">編集</a>
