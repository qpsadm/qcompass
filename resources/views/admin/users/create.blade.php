...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">User作成</h1>
...
<div class="mb-4">
    ...
    <input type="text" name="role_id" value="{{ old('role_id', $User->role_id ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
<div class="mb-4">
    <label class="block font-medium mb-1">courses_id</label>
    <input type="text" name="courses_id" value="{{ old('courses_id', $User->courses_id ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
<div class="mb-4">
...
<div class="mb-4">
    ...
    <input type="text" name="created_user_id" value="{{ old('created_user_id', $User->created_user_id ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
<div class="mb-4">
    <label class="block font-medium mb-1">updated_user_id</label>
    <input type="text" name="updated_user_id" value="{{ old('updated_user_id', $User->updated_user_id ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
<div class="mb-4">
    <label class="block font-medium mb-1">deleted_at</label>
    <input type="text" name="deleted_at" value="{{ old('deleted_at', $User->deleted_at ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
<div class="mb-4">
    <label class="block font-medium mb-1">deleted_user_id</label>
    <input type="text" name="deleted_user_id" value="{{ old('deleted_user_id', $User->deleted_user_id ?? '') }}" class="border px-2 py-1 w-full rounded">
</div>
