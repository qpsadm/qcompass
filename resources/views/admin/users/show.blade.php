...
@section('content')
    <div class="container mx-auto p-4 max-w-5xl" x-data="{ tab: '{{ request('tab', 'basic') }}' }">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-5xl mx-auto">
            ...
            {{-- 基本情報 --}}
            <div x-show="tab === 'basic'" x-cloak class="bg-white shadow rounded-lg">
            ...
            {{-- 詳細情報 --}}
            <div x-show="tab === 'detail'" x-cloak class="bg-white shadow rounded-lg">
                    ...
                    @php
                        $details = [
                            ...
                            'プロフィール写真' => $detail->avatar_path
                                ? '<img src="' .
                                    asset('storage/' . $detail->avatar_path) .
                                    '"
                        ...
                        <tbody>
                            @foreach ($details as $label => $value)
                                <tr class="border-b">
                                    ...
                                    <td class="px-4 py-2 break-words">
                                        {!! str_contains((string) $value, '<img') ? $value : e($value) !!}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
