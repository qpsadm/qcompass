    ...
    <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-4 gap-3">
        ...
        <div class="flex items-center space-x-2 mb-2 lg:mb-0">
            ...
            <a href="{{ route('admin.users.create') }}"
                class="bg-blue-500 px-4 py-2 rounded hover:bg-blue-600 text-white flex items-center gap-1">
                ＋ 新規作成
            </a>
        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center gap-2">
            ...
            <!-- 講座選択 + 未所属 -->
            <form method="GET" action="{{ route('admin.users.index') }}" class="flex items-center space-x-2 mb-2 lg:mb-0">
            ...
            <div x-data="searchBox()" class="flex items-center space-x-2">
                ...
                <button @click="submit()"
                    class="bg-blue-500 px-4 py-1 rounded hover:bg-blue-600 text-white">検索</button>
            </div>
