...
@section('content')
<div class="container mx-auto p-4 min-h-screen" x-data="{ open: false, deleteUrl: '', deleteName: '' }">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2 text-center">
                        ...
                        <a href="{{ route('admin.users.edit', $User->id) }}" class="text-blue-600 ml-2 hover:underline">
                            編集
                        </a>
                        <button
