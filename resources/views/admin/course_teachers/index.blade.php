        ...
        <table class="table-auto border-collapse border w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border px-4 py-2">{{ $teacher->course?->course_name ?? '-' }}</td>
                    ...
                    <td class="border px-4 py-2 text-center">
                        <div class="flex items-center justify-center flex-nowrap space-x-2">
                            <!-- 詳細 -->
                            <a href="{{ route('admin.course_teachers.show', $teacher->id) }}"
                            ...
                            <!-- 削除 -->
                            <button @click="open = true; deleteUrl='{{ route('admin.course_teachers.destroy', $teacher->id) }}'; deleteName='{{ $teacher->user?->name ?? '削除対象' }}';"
