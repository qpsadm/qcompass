...
@section('content')
    <div class="container p-4 min-h-screen bg-white rounded-lg shadow-md">
        ...
        <div class="flex items-center space-x-2">
            ...
            <a href="{{ route('admin.course_teachers.index') }}"
                class="back flex items-center bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded transition">
