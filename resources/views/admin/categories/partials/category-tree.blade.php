...
<ul class="space-y-2">
    @foreach ($categories as $key => $category)
        <li x-data="{ open: false }">
            ...
            <div
                class="flex items-center justify-between bg-white rounded-md border border-gray-300 shadow-sm py-2 px-3 hover:bg-gray-200">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col w-96">
                        ...
                        <span class="text-s text-gray-800">
                ...
                <div class="flex items-center gap-2 w-20">
                    @if ($category->is_show)
                        <span class="px-2 py-2 bg-green-100 text-green-800 rounded-full text-xs">
                            表示
                        </span>
                    @else
                        <span class="px-2 py-2 bg-gray-200 text-gray-700 rounded-full text-xs">
                            非表示
                        </span>
                    @endif
                </div>
                @if ($showActions)
                    ...
                    <div class="flex items-center gap-2 w-32">{{ $category->updated_user_name }}</div>
