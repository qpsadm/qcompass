...
@section('content')
    <div class="container max-w-5xl" x-data="{ open: false, deleteUrl: '', deleteName: '' }">
        <div class="bg-white rounded-lg shadow-md p-6 mx-auto">

            <!-- タイトル -->
            <h1 class="text-2xl font-bold mb-4">ゴミ箱カテゴリ一覧</h1>
            <a href="{{ route('admin.categories.index') }}"
                class="back inline-block mb-4 px-4 py-2 bg-gray-100 text-white rounded hover:bg-gray-200 transition">
                一覧へ戻る
            </a>
            ...
            <div class="bg-white shadow-md rounded-lg p-4 overflow-x-auto">
                <ul class="space-y-2">
                    @forelse ($categories as $category)
                        <li
                            class="flex items-center justify-between bg-white rounded-md shadow-sm py-2 px-3 hover:bg-gray-50">
