            ...
            <form
                ...
                <table class="w-full table-auto border-collapse">
                    <tbody>
                        {{-- 求人タイトル --}}
                        <tr class="border-b">
                            <th class="w-60 px-4 py-2 bg-gray-100 text-right font-medium">求人タイトル <span
                        ...
                        @foreach (range(1, 5) as $i)
                            ...
                            @endphp
                            <tr class="border-b">
                                <th class="w-60 px-4 py-2 bg-gray-100 text-right font-medium">PDFファイル{{ $i }}
                                </th>
                                <td class="px-4 py-2 flex flex-col gap-2" x-data="{
                                    ...
                                    <template x-if="fileName">
                                        <div class="flex items-center gap-2 text-sm break-all">
                                            ...
                                            <a :href="virtualUrl" target="_blank"
                                                class="text-blue-600 underline break-all" x-text="virtualUrl"></a>
