    ...
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="border p-4 rounded mb-4">
                ...
                <p><strong>PDFファイル保存パス1:</strong> {{ $job_offer->file_path1 }}</p>
                <p><strong>PDFファイル保存パス2:</strong> {{ $job_offer->file_path2 }}</p>
                <p><strong>PDFファイル保存パス3:</strong> {{ $job_offer->file_path3 }}</p>
                <p><strong>PDFファイル保存パス4:</strong> {{ $job_offer->file_path4 }}</p>
                <p><strong>PDFファイル保存パス5:</strong> {{ $job_offer->file_path5 }}</p>
