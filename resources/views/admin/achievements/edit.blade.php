        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('admin.achievements.update', $Achievement->id) }}" method="POST">
                ...
                <div class="mt-6 flex gap-3">
                    <button type="submit"
                        class="save bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded shadow">更新</button>
                    <a href="{{ route('admin.achievements.index') }}"
                        class="backbg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded shadow">一覧に戻る</a>
                </div>
            </form>
        </div>
    </div>
