    ...
    <div class="container mx-auto p-4 min-h-screen" x-data="{ deleteOpen: false }">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-5xl mx-auto">
            ...
            <div class="mt-6 flex gap-3">
                {{-- <button type="button" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded preview-button"
                    data-content='@json($agenda->content)' data-title="{{ $agenda->agenda_name }}">
                    プレビュー
                </button> --}}
