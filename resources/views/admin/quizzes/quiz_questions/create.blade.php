...
@section('content')
    <div class="container mx-auto p-6 max-w-5xl bg-white rounded-lg shadow-md">
        <h1 class="text-3xl font-bold mb-6">クイズ問題作成: {{ $quiz->title }}</h1>
        ...
        <form action="{{ route('admin.quizzes.quiz_questions.store', $quiz->id) }}" method="POST">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="save bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600 transition">
                    登録
                </button>
