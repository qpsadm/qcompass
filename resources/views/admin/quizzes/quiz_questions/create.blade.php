...
@section('content')
    <div class="container max-w-5xl">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mx-auto">
            ...
            <h1 class="text-2xl font-bold mb-6 text-gray-800">クイズ問題 作成: {{ $quiz->title }}</h1>
            ...
            <form action="{{ route('admin.quizzes.quiz_questions.store', $quiz->id) }}" method="POST">
                ...
                <div class="mt-6 flex gap-3">
                    <button type="submit"
                        class="save bg-green-500 text-white px-6 py-2 rounded hover:bg-green-600 transition">
                        登録
                    </button>
