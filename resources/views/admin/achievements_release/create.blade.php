...
<div class="container mx-auto p-6">
    <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-gray-800">実績解除作成</h1>
        ...
        <form action="{{ route('admin.achievements_release.store') }}" method="POST">
            @csrf
            <table class="w-full table-auto border-collapse">
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <select name="achievement_master_id" class="border rounded px-3 py-2 w-full">
                                ...
                                <option value="{{ $achievement->id }}" @selected(old('achievement_master_id')==$achievement->id)>{{ $achievement->title }}</option>
                                @endforeach
                            </select>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2">
                            <input type="text" name="condition_met" value="{{ old('condition_met') }}"
                                class="border rounded px-3 py-2 w-full">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded">保存</button>
