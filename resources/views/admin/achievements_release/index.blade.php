        ...
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-4 gap-2">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('admin.achievements_release.create') }}"
                    class="new bg-blue-500 px-4 py-2 rounded hover:bg-blue-600 hover:text-white transition flex items-center space-x-1">
                    ...
                    @foreach ($achievements_release as $AchievementsRelease)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border px-4 py-2">
                                @if (
                                    $AchievementsRelease->user &&
                                        $AchievementsRelease->user->courses &&
                                        $AchievementsRelease->user->courses->count() > 0)
                            ...
                            <td class="border px-4 py-2 text-center">
                                <div class="flex items-center justify-center flex-nowrap space-x-2">
                                    ...
                                    <!-- 削除 -->
                                    <button
                                        @click="open = true; deleteUrl='{{ route('admin.achievements_release.destroy', $AchievementsRelease->id) }}'; deleteName='{{ $AchievementsRelease->user->name ?? 'なし' }} - {{ $AchievementsRelease->achievement->title ?? 'なし' }}';"
