                ...
                <tbody>
                    @foreach ($announcements as $item)
                        <tr>
                            ...
                            <td class="border px-4 py-2 text-center">
                                @if ($item->status == 0)
                                    <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">下書き</span>
                            ...
                            <td class="border px-4 py-2 text-center">
                                <div class="flex items-center justify-center flex-nowrap space-x-2">
                                    ...
                                    <!-- 削除 -->
                                    <button
                                        @click="open = true; deleteUrl='{{ route('admin.announcements.destroy', $item->id) }}'; deleteName='{{ $item->title }}';"
