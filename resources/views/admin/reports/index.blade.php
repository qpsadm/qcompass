...
<div class="container mx-auto p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <table class="table-auto border-collapse border w-full">
            <thead>
                <tr>
                    <th class='border px-4 py-2'>提出者ID</th>
                    <th class='border px-4 py-2'>講座ID</th>
                    <th class='border px-4 py-2'>日報対象日</th>
                    <th class='border px-4 py-2'>タイトル</th>
                    <th class='border px-4 py-2'>日報</th>
                    <th class='border px-4 py-2'>感想・気づき・質問</th>
                    <th class='border px-4 py-2'>連絡事項</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class='border px-4 py-2'>{{ $Report->created_user_name }}</td>
                    <td class='border px-4 py-2'>{{ $Report->updated_user_name }}</td>
                    <td class='border px-4 py-2'>{{ $Report->deleted_at }}</td>
                    <td class='border px-4 py-2'>{{ $Report->deleted_user_name }}</td>
