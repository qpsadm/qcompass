                ...
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border px-4 py-2">
                            <a
                                href="{{ route('admin.reports.index', array_merge(request()->query(), ['sort' => 'user_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}">
                                提出者
                        ...
                        <th class="border px-4 py-2">
                            <a
                                href="{{ route('admin.reports.index', array_merge(request()->query(), ['sort' => 'course_id', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}">
                                講座
                        ...
                        <th class="border px-4 py-2">
                            <a
                                href="{{ route('admin.reports.index', array_merge(request()->query(), ['sort' => 'date', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}">
                                日付
                        ...
                        <th class="border px-4 py-2">
                            <a
                                href="{{ route('admin.reports.index', array_merge(request()->query(), ['sort' => 'created_at', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc'])) }}">
                                送信日時
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 text-center">
                                <div class="flex items-center justify-center flex-nowrap space-x-2">
                                    ...
                                    <!-- 削除 -->
                                    <button
                                        @click="open = true; deleteUrl='{{ route('admin.reports.destroy', $report->id) }}'; deleteTitle='{{ $report->title }}';"
