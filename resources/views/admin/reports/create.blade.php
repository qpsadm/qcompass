...
@section('content')
    <div class="container p-4 max-w-3xl">
        <h1 class="text-3xl font-bold mb-6">日報作成</h1>

        <form id="reportForm" action="{{ route('admin.reports.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit"
                    class="save bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded w-1/2">登録</button>

                <button type="button" onclick="previewReport()"
                    class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded w-1/2">プレビュー</button>
            </div>
        </form>
    </div>
