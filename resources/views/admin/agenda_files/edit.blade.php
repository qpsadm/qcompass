...
@section('content')
    <div class="container mx-auto p-4 max-w-lg">
        ...
        <form action="{{ route('admin.agenda_files.update', $agendaFile->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                @if ($agendaFile->file_path)
                    <p class="text-sm text-gray-500 mt-1">現在のファイル: {{ $agendaFile->file_name ?? $agendaFile->file_path }}
                    </p>
                @endif
            </div>
