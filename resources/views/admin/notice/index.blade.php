...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4 flex justify-between items-center">
            <a href="{{ route('admin.notice.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">新規作成</a>
        </div>
            ...
            <tbody>
                @forelse ($agendas as $agenda)
                    <tr class="hover:bg-gray-50">
                        <td class="border px-4 py-2">{{ optional($agenda->course)->name ?? '不明な講座' }}</td>
                        ...
                        <td class="border px-4 py-2 text-center">
                            <a href="{{ route('admin.notice.edit', $agenda->id) }}"
                                class="text-blue-500 hover:underline mr-2">編集</a>
                            <form action="{{ route('admin.notice.destroy', $agenda->id) }}" method="POST"
