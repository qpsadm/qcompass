...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">QuizAttempt一覧</h1>
    <a href="{{ route('quiz_attempts.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">新規作成</a>
...
<th class='border px-4 py-2'>started_at</th>
<th class='border px-4 py-2'>completed_at</th>
<th class='border px-4 py-2'>score</th>
<th class='border px-4 py-2'>status</th>
<th class='border px-4 py-2'>attempt_no</th>
<th class='border px-4 py-2'>ip_address</th>
...
<td class='border px-4 py-2'>{{ $QuizAttempt->ip_address }}</td>
                ...
                <td class='border px-4 py-2'>
                    ...
                    <form action="{{ route('quiz_attempts.destroy', $QuizAttempt->id) }}" method="POST" class="inline-block ml-2">
                        @csrf
                        @method('DELETE')
