...
<div class="container mx-auto p-4 max-w-lg">
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    @if($agendaFile->file_path)
                        <a href="{{ asset('storage/' . $agendaFile->file_path) }}" class="text-blue-500 underline" target="_blank">ダウンロード</a>
                    @else
                        -
                    @endif
                </td>
    ...
    <div class="flex gap-2 mt-4">
        ...
        <a href="{{ route('agenda_files.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded">一覧に戻る</a>
    </div>
</div>
@endsection
