    ...
    <div class="container">
        ...
        <div class="section-box">
            ...
            <div class="box-content">
                <x-f_content_list :items="$agendas" title-field="agenda_name" link-route="user.agenda.info" param-name="id"
                    :is-news="false" />
                <div class="more-btn">
        ...
        <div class="section-box">
            ...
            <div class="box-content">
                <x-f_content_list :items="$courseAnnouncements" :is-news="true" />
                <div class="more-btn">
        ...
        <div class="section-box">
            ...
            <div class="box-content">
                <x-f_content_list :items="$globalAnnouncements" :is-news="true" />
                <div class="more-btn">
        ...
        <div class="section-flex">
            ...
            <div class="section-box job-offer">
                ...
                <div class="box-content">
                    <x-f_content_list :items="$jobs" link-route="user.job.job_offers_info" param-name="id"
                        :is-news="false" />
                    <div class="more-btn">
