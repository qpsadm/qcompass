                    ...
                    <div class="form-right">
                        ...
                        <div class="avatar">
                            ...
                            <div class="img-container">
                                <input type="radio" id="img1" name="avatar-img" value="1"
                                    {{ ($user_details->fontsize ?? 2) == 1 ? 'checked' : '' }}>
                                <label for=""><img src="{{ asset('assets/images/f_profile_image1.svg') }}"
                                        alt="" class="avatar-img"></label>

                                <input type="radio" id="img1" name="avatar-img" value="1"
                                    {{ ($user_details->fontsize ?? 2) == 1 ? 'checked' : '' }}>
                                <label for=""><img src="{{ asset('assets/images/f_profile_image2.svg') }}"
                                        alt="" class="avatar-img"></label>

                                <input type="radio" id="img1" name="avatar-img" value="1"
                                    {{ ($user_details->fontsize ?? 2) == 1 ? 'checked' : '' }}>
                                <label for=""><img src="{{ asset('assets/images/f_profile_image3.svg') }}"
                                        alt="" class="avatar-img"></label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="section-box profile">
                ...
                <div class="box-content">
                    <div class="profile-icon">
                        <img src="{{ $user_details->avatar_type_image }}" alt="プロフィール画像">
                    </div>
                    <div class="profile-data">
                        <h4>{{ $user->name }}</h4>
                        <p class="mail">{{ $user->email ?? '未登録' }}</p>
