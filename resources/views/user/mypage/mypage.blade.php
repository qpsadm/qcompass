...
<div class="container">
    ...
    <div class="modal-avatar">
        <form id="avatar-form" action="{{ route('user.settings.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="avatar">
                    ...
                    <div class="img-container">
                        ...
                        @for ($i = 1; $i <= 15; $i++)
                            ...
                            <label for="avatar{{ $i }}">
                                <img src="{{ asset("assets/images/profile/f_profile_image{$i}.svg") }}" class="avatar-img">
                            </label>
                            @endfor

                            {{-- カスタム 99 --}}
                            <input type="radio" id="avatar99" name="avatar_type" value="99" {{ $avatarType == 99 ? 'checked' : '' }}>
