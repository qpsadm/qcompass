            ...
            <div class="form-container">
                ...
                <div class="form-left">
                    ...
                    <div class="font-size-select">
                        ...
                        <div class="radio-container">
                            <input type="radio" id="small" name="fontsize" value="1" {{ $fontSize == 1 ? 'checked' : '' }}>
                            <label for="small">標準</label>

                            <input type="radio" id="medium" name="fontsize" value="2" {{ $fontSize == 2 ? 'checked' : '' }}>
                            <label for="medium">中</label>

                            <input type="radio" id="large" name="fontsize" value="3" {{ $fontSize == 3 ? 'checked' : '' }}>
        ...
        <div class="section-box profile">
            ...
            <div class="box-content">
                <div class="profile-icon">
                    <img src="{{ $user_details->avatar_type_image ?? asset('assets/images/f_profile_image1.svg') }}" alt="プロフィール画像">
                </div>
                <div class="profile-data">
                    <h4>{{ $user->name }}</h4>
                    <p class="mail">{{ $user->email ?? '未登録' }}</p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            dateClick: function(info) {
                var event = calendar.getEvents().find(event => event.startStr === info.dateStr && event.extendedProps.url);
            ...
            datesSet: function() {
                document.querySelectorAll('.fc-daygrid-day-frame').forEach(frame => {
                    ...
                    var hasEvent = calendar.getEvents().some(event => event.startStr === date && event.extendedProps.url);
