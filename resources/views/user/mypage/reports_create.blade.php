    ...
    <div class="form-content">
        ...
        <form class="report-form" action="{{ route('user.reports_store') }}" method="POST">
            ...
            <div class="form-item">
                ...
                <input type="email" id="mail" value="{{ Auth::user()->email }}" readonly>
            </div>
            ...
            <div class="form-item">
                ...
                <textarea name="daily_report" id="daily-report-input" rows="6" placeholder="本日の講習で学んだ内容や報告したい内容をご記入ください。" required></textarea>
            </div>
