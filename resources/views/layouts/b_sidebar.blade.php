    ...
    @if (auth()->user()->role_id === 1)
        <aside id="sidebar"
            ...
            <nav class="flex flex-col gap-2">
                ...
                {{-- ユーザー管理（サブメニューあり） --}}
                <div>
                    <button id="userMenuBtn" class="flex items-center justify-between w-full p-2 rounded hover:bg-gray-700">
                        <span>ユーザー管理</span>
                        <svg class="w-4 h-4 transition-transform" fill="currentColor" viewBox="0 0 20 20" id="userMenuIcon">
